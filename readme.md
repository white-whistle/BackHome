...
#### Showcase Video
[![Video showcase of BackHome mod on youtube](https://img.youtube.com/vi/7j3q2NnCZOc/0.jpg)](https://www.youtube.com/watch?v=7j3q2NnCZOc)
...
## Progression
`Back Home` lets you exploit turtle architecture, so firsts thing first - lets get our hands on some turtle scute!
But turtles might be a little annoying to find... (maybe they are just shy?)

On your journey to finding turtles, you might spot enemies holding pizza slices - turtles seem to like pizza, so you keep any dropped pizza slices handy
<p><img height="400px" alt="image" src="https://github.com/user-attachments/assets/6cb0e94d-e86e-4ba1-b825-3f2ef9a1dfe5" /></p>
...
<p><img src="https://github.com/white-whistle/BackHome/blob/main/raw/pizza_fishing.gif?raw=true" /></p>
...
This will teleport us to plot #0, anyone on the server can access this plot - so be cautious, it may become a torture chamber on some servers... on nicer servers, this can act as a hub world :D
...
<p>
  <img width="503" height="170" alt="image" src="https://github.com/user-attachments/assets/98f49cf2-8484-4ee4-9d33-15f6edc67150" />
</p>
<p>
  <img width="332" height="226" alt="image" src="https://github.com/user-attachments/assets/42d1e7ed-9e07-4b45-b01a-31f625325f89" />
</p>

You notice your house is getting a little tight with all of your friends inside, so you decide to rennovate a little.
You realize that this turtle shell is a tough nut to crack.. none of your tools seem to be able to break it...
...
You keep farming for plastic bags, while helping the environment is cool and all, the monotony of the grind takes a toll on you.. in a moment of desparity you attach a bundle to your fishing rod and toss the whole thing into the ocean, suprisingly after reeling the bundle in, you are met with quite the haul, one might say it is exactly x9 more efficient than standard fishing!
<p><img src="https://github.com/white-whistle/BackHome/blob/main/raw/bundle_fishing.gif?raw=true" /></p>

... And with that, this story comes to an end, but fear not - as this is only the beginning of your own story. go out there, with your turtle armor on your back, and break everything! the world is your oyster.
👋

## Commands
In case you really mess up, or just want to mess around

to teleport to plot #`index` run:
```
/tpTurtlePlot index
```


to get a deed bound to plot #`index` run:
```
/giveTurtlePlotDeed index
```
...
you are allowed to use this in a modpack :)
