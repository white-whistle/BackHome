...
public interface ModArmorMaterials {
    ArmorMaterial SHELLITE = new ArmorMaterial(
            25, createDefenseMap(2, 5, 8, 2, 5), 9, SoundEvents.ITEM_ARMOR_EQUIP_TURTLE, 0.0F, 0.0F, ItemTags.REPAIRS_TURTLE_HELMET, EquipmentAssetKeys.TURTLE_SCUTE
    );
